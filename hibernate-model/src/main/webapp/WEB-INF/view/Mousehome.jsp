								...
								<div class="mt-3">
									...
									<%
										...
										<%
											...
											<strong>Quantity: </strong><input style="width: 50px;" type="number" name="quantity" value=1  min="1" max="${mouse.quantity}">
											<button class="btn btn-primary">Add to Cart</button>
											</form>
												&nbsp;&nbsp;&nbsp;&nbsp; 
											<form action="/hibernate-model/paymentProduct" method="get">
											<input type="hidden" name="productID" value="${mouse.productID}">
											<strong>Quantity: </strong><input style="width: 50px;" type="number" name="quantity" value=1 min="1" max="${mouse.quantity}"><br>
