                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-right">
                            <h4 style="color: #F81D2D;"><strong>Have a Nice Day...</strong></h4>
                            <h5><strong>Shipping Address</strong><h5>
                            <p>${order.key.shippingAddress}</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2>INVOICE</h2>
                            <p><strong>${order.key.orderId}</strong></p>
                        </div>
                    </div> <br />
                    <div>
                        <table class="table">
                            ...
                            <c:forEach var="orderItem"  items="${order.value}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p> <strong>$ ${order.key.orderCost}</strong> </p>
                                ...
                                <tr style="color: #F81D2D;">
                                    ...
                                    <td></td>
                                    <td class="text-left">
                                        <h3><strong>$ ${order.key.orderCost}</strong></h3>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div>
                        <div class="col-md-12">
                            <p><b>Date :</b>${order.key.orderDate}</p> <br />
                        </div>
                    </div>
                </div>
            </div>
